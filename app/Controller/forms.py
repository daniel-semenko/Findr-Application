...
class PostForm(FlaskForm):
    ...
    qualifications = TextAreaField('Qualifications Required', validators=[DataRequired(), Length(min=1, max=300)])
...
class SortForm(FlaskForm):
    sortorder = SelectField('Sort', choices=[(4, 'Date'), (3, 'Title'), (2,'# of likes'), (1, 'Happiness level')])
